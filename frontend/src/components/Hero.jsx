...
const Hero = () => {
  return (
    <>
      ...
      <section id="sobre-nosotros" className="mt-12 px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
          {/* Sobre nosotros */}
          <div className="bg-black/20 p-6 rounded-lg shadow-lg">
            <h2 className="text-2xl sm:text-3xl font-semibold text-white mb-3">Sobre nosotros</h2>
            <p className="text-gray-400">
              Somos una plataforma dedicada a guiar a estudiantes y profesionales en su camino vocacional, 
              brindando herramientas precisas y confiables para descubrir su verdadera pasión.
            </p>
          </div>

          {/* Ayuda de IA */}
          <div id="ayuda-ia" className="bg-black/20 p-6 rounded-lg shadow-lg">
            <h2 className="text-2xl sm:text-3xl font-semibold text-white mb-3">¿Ayuda de IA?</h2>
            <p className="text-gray-400">
              Nuestra inteligencia artificial analiza tus respuestas y preferencias para ofrecerte 
              recomendaciones personalizadas sobre carreras y áreas de estudio que se alinean con tus intereses y habilidades.
            </p>
          </div>
        </div>
      </section>
